  ...
  return (
    <>
      <div className="static">
        <div className={` ${modalBehavior} absolute z-1 w-[510px] h-[495px]  ml-16  mt-[11px] bg-white shadow-xl rounded-md`}>
          <div className=" bg-[#829aad] flex flex-row  py-2 px-8 w-full h-19 rounded-t-md">
            <div className="">
          ...
          <div className="flex text-md pt-6 p-2.5 mx-8 font-normal ">
            <div>
              <h5 className="mt-1">Koordinat : </h5>
            </div>
